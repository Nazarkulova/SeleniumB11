...
public class Cars {
    ...
    public void BMW() throws InterruptedException {
        ...
        // choose the options you want for yourcar
        //click search button
        //validate the header
        // and validate all the subheader contains the name of the cars you are looking for
        // .clear -->sendKeys
        ...
        WebElement make = driver.findElement(By.xpath("//select[@id='models']"));
